...
public sealed partial class ModSuitComponent : Component
{
    ...
    public string BackgroundPath = "/Textures/_ADT/Interface/Backgrounds/Modsuits/nanotrasen_background.png";
    [DataField, AutoNetworkedField]
    ...
    /// </summary>
    [DataField]
    public SoundSpecifier FullyEnabledSound = new SoundPathSpecifier("/Audio/_ADT/Mecha/nominal.ogg");
