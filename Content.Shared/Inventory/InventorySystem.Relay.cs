...
using Content.Shared._White.Overlays; // WD edit
...
public partial class InventorySystem
{
    public void InitializeRelay()
    {
        ...
        SubscribeLocalEvent<InventoryComponent, RefreshEquipmentHudEvent<NightVisionComponent>>(RefRelayInventoryEvent); // Goob edit
        SubscribeLocalEvent<InventoryComponent, RefreshEquipmentHudEvent<ThermalVisionComponent>>(RefRelayInventoryEvent); // Goob edit
