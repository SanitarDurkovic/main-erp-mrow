...
petting-success-scurret = Вы гладите { $target } по { POSS-ADJ($target) } законно отличной голове.
...
petting-failure-scurret = You reach out to pet { $target }, but { SUBJECT($target) } does a backflip!
