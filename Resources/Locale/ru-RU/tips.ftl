...
tips-dataset-128 = Существует предел химического метаболизма, который ограничивает количество реагентов определенного типа, которые вы можете переварить за один раз. Некоторые виды имеют более высокие пределы метаболизма, например, слаймолюды.
...
tips-dataset-139 = Обязательно протирайте незаконные имплантанты мылом или влажной тряпкой после их использования! Детективы могут сканировать использованные имплантанты на предмет наличия улик в виде ДНК, но только в том случае, если они не были тщательно очищены.
