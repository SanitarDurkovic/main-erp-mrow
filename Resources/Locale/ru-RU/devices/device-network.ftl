...
device-frequency-prototype-name-turret = Защитная турель
device-frequency-prototype-name-turret-control = Управление защитной турелью
...
device-address-prefix-turret = ЗТМК-
