...
signal-port-description-air-danger = Этот порт задействуется с высоким уровнем сигнала, когда статус "Опасность", и низким уровнем, если статус другой.
signal-port-name-air-warning = Предупреждение
signal-port-description-air-warning = Этот порт задействуется с высоким уровнем сигнала, когда статус "Предупреждение", и низким уровнем, если статус другой.
signal-port-name-air-normal = Норма
signal-port-description-air-normal = Этот порт задействуется с высоким уровнем сигнала, когда статус "Норма", и низким уровнем, если статус другой.
...
signal-port-description-item-detected = Этот порт задействуется всякий раз, когда обнаруживается батарея.
