...
marking-LizardSnoutSharp-snout_sharp = Унатх, морда (Заостреная)
marking-LizardSnoutSharp = Унатх, морда (Заостреная)
...
marking-LizardChestFin-body_fin = Плавник Ящерицы
marking-LizardChestFin = Плавник Ящерицы
