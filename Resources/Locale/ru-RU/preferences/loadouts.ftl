...
loadout-name-edit-label-dataset = Задаёт пользовательское имя, которое будет использоваться, если вы будете играть эту роль. Если оно пустое, вместо него будет выбрано случайное имя.
