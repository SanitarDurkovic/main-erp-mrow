...
book-gior-contents =
    ...
    В состав данной организации входят все виды галактики, интересы которых представляют их представители. От каждого вида может выдвигаться несколько представителей, и их число зависит от численности самого вида (1 представитель на 10 миллиардов представителей этого вида). Из-за того, что точное число представителей какого-либо вида подчитать достаточно сложно, общим решением принято округлять число представителей в меньшую сторону. Также важным уточнением будет, что ГИОРиМУ является надгосударственным формированием, а значит, что представители рас могут являться гражданами разных государств.
