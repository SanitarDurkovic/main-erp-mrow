...
implanter-draw-failed-catastrophically = Имплантер ничего не находит и катастрофически выходит из строя, перебрасывая генетический материал в руку { $user }!
implanter-component-implant-already = { $target } уже имеет { $implant }!

## UI

implanter-set-draw-verb = Удаление импланта
implanter-set-draw-window = Удалить импланта
