...
admin-solutions-window-solution-button-tooltip = Открывает соответствующий экземпляр серверного раствора в ViewVariables. Полезно для отладки проблем с предсказанием.
...
admin-solutions-window-thermals = Тепловые потоки
