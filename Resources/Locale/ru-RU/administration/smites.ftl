...
admin-smite-electrocute-description = Поражает цель электрическим током, делая бесполезным все, что было на неё надето.
...
admin-smite-become-bread-description = Превращает цель в хлеб. И все.
...
admin-smite-become-instrument-description = Превращает цель в суперсинтезатор. И все.
...
admin-smite-garbage-can-description = Превратите цель в мусорку, чтобы подчеркнуть, о чем она вам напоминает.
...
admin-smite-crawler-description = Заставляет цель упасть и не даёт ей встать. Также удаляет руки для пущего эффекта!
