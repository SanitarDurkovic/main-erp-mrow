...
zombieteors-description = На станции во время катаклизмического метеоритного дождя появились зомби! Работайте вместе с членами экипажа и сделайте все возможное, чтобы выжить!
...
zombie-infection-warning = Вы чувствуете, как зомби-вирус берет верх
