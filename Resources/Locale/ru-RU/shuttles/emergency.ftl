...
cmd-delayroundend-desc = Останавливает таймер, завершающий раунд, когда аварийный шаттл выходит из гиперпространства.
...
cmd-launchemergencyshuttle-desc = Досрочно запускает экстренный шаттл, если это возможно.
