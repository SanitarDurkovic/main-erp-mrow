...
xenoarch-trigger-tip-plasma = Не-твердая плазма
...
xenoarch-trigger-tip-examine = Внимательный осмотр
...
xenoarch-trigger-examine-wrenching = Там болтается какая-то раскрученная деталь.
xenoarch-trigger-examine-prying = От поверхности отходит панель.
xenoarch-trigger-examine-screwing = Есть приподнятая секция с небольшим углублением.
xenoarch-trigger-examine-pulsing = Из поверхности артефакта торчит открытый диод.
xenoarch-trigger-examine-timer = Резьба и царапины покрывают поверхность... Вы едва можете различить число: [italic]{ $time }[/italic]
xenoarch-effect-puddle = Создает лужу из следующих реагентов: { $reagent }
xenoarch-effect-foam = Создает пену из следующих реагентов: { $reagent }
