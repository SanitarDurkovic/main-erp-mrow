...
ghost-gui-toggle-lighting-manager-popup-personal-light = Включён персональный цвет.
ghost-gui-toggle-lighting-manager-popup-fullbright = Максимальная яркость.
