...
cmd-pardon-unable-to-parse =
    ...
    { $help }
cmd-pardon-already-pardoned = Этот бан уже разбанен.
cmd-pardon-already-pardoned-specific = Этот бан уже разбанен { $admin } в { $time }.
cmd-pardon-success = Бан с ID { $id } разбанен.
