...
bounty-description-research-disk = Оказывается, эти недоумки из отдела исследований тратят все своё время на приобретение оборудования для уборки. Отправьте несколько исследований в Центральное командование, чтобы мы могли действительно получить то, что нам нужно.
...
bounty-description-flashes = ПРИВЕТСТВИЕ \[Станция] НАМ НЕОБХОДИМЫ 6 ВСПЫШЕК ДЛЯ ОБЫЧНЫХ \[ТренировкаУпражнение] С СОТРУДНИКАМИ СЛУЖБЫ БЕЗОПАСНОСТИ. ВСЕ \[Нормально].
...
bounty-description-tooth-sharkminnow = Шеф-повар утверждает, что зубы карпоакулы - это что-то вроде высококачественного ножа. Я не знаю о чем он говорит, но он хочет получить набор. Отправьте его ему.
