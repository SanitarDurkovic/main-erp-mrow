...
bounty-item-ore-plasma = Плазмовая руда
...
bounty-item-plates = Пластины для скрытия Голиафа
...
bounty-description-ring = В этот ЧРЕЗВЫЧАЙНЫЙ день состоится свадьба между семьями Гелтов, но мистер Гелт потерял кольца, отправьте пару колец.
