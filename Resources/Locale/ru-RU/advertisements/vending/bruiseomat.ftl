...
advertisement-bruiseomat-13 = Черт, я не знал, что меня перевезли обратно в учебку для кадетов!
...
thankyou-bruiseomat-22 = 5 телекристаллов ставлю, что ты не доберёшься до шаттла прежде, чем упадёшь.
...
thankyou-bruiseomat-27 = Сколько вы уже выпили? Я сбился со счета.
