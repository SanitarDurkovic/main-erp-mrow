...
chem-master-window-buffer-all-amount = Все
...
chem-master-window-sort-type-none = Сортировать по: Самый старый
...
chem-master-window-sort-type-latest = Сортировать по: Сначала новый
