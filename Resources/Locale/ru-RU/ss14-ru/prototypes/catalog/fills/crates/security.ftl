ent-CrateSecurityArmor = ящик с броней
...
ent-CrateSecNonlethalThrowables = ящик с нелетальными средствами
    .desc = Содержит по одной коробке светошумовых гранат, электрошокеров, гранат со слезоточивым газом и четыре боло. Для открытия требуется доступ СБ.
