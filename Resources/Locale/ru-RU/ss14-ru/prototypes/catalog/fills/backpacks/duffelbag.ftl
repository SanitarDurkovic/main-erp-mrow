...
ent-ClothingBackpackDuffelSyndicateFilledSMG = { ent-ClothingBackpackDuffelSyndicate }
    .desc = { ent-ClothingBackpackDuffelSyndicate.desc }
    .suffix = набор "C-20r"
ent-ClothingBackpackDuffelSyndicateFilledRifle = Комплект Эсток
    .desc = Для снайперской стрельбы на средней дистанции: Эсток. В комплекте три магазина.
...
ent-ClothingBackpackDuffelAcolyteBundle = набор брони послушника
    .desc = Содержит броню послушника, необходимую вещь для любого лидера культа.
