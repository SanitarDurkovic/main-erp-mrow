...
ent-BookNakamura = Инженерия Накамуры
    .desc = Чем занимаются в корпорации Большой Пятёрки Инженерия Накамуры
...
ent-BookUnath1 = Культура унатхов (ч.1)
    .desc = Первая часть великолепного исследования этого прекрасного вида
ent-BookUnath2 = Культура унатхов (ч.2)
    .desc = Вторая часть великолепного исследования этого прекрасного вида
