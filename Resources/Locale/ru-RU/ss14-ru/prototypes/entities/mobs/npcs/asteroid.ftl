...
ent-FoodHivelordRemains = остатки повелителя роя
    .desc = Это все, что осталось от повелителя роя, и, похоже, именно это позволяет ему безвредно отделять от себя части... Его целебные свойства скоро утратят силу, если не воспользоваться ими поскорее. Постарайтесь не думать о том, что именно вы едите.
ent-FoodHivelordRemainsInert = инертные остатки повелителя роя
    .desc = Это все, что осталось от повелителя роя... Теперь точно все.
ent-MobBasilisk = базилиск
