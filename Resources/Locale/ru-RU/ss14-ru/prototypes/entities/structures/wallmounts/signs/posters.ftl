...
ent-PosterContrabandExoAcid = Внимание, экзоморф: Кислотная плеть!
    .desc = Этот плакат предупреждает об едкой плети экзоморфа. Не то чтобы такие экзоморфы были настоящими... Верно?
ent-PosterContrabandExoRun = Внимание, экзоморф: Убегай!
    .desc = Этот плакат предупреждает об атлетичном экзоморфе, способном утащить любого, кто попадётся; так что не попадайтесь!
ent-PosterContrabandExoChomp = Внимание, экзоморф: Опасные укусы!
    .desc = Этот плакат предупреждает о смертельных укусах, которые могут наносить экзоморфы. Не станьте закуской для пришельца!
...
ent-PosterLegitHelio = Реклама Helio Logistics
    .desc = Плакат, рекламирующий Helio Logistics и их очаровательного маскота. Слоган гласит: «В дождь и в зной, мы доставим в срок».
