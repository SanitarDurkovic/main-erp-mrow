...
ent-SignGenpop = знак "следственный изолятор"
    .desc = Знак, указывающий на тюрьму общего контингента.
...
ent-SignZomlab = знак "зомби-лаборатория"
    .desc = Последние остатки закрытого исследовательского проекта NanoTrasen, целью которого было использование силы Ромерола. Интересно, чем все закончилось...
...
ent-SignDetective = Знак детектив
    .desc = Знак с изображением офиса детектива.
