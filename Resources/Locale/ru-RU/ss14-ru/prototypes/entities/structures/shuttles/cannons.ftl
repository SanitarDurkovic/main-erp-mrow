...
ent-ShuttleGunKineticOld = экзоморфный дематериализатор
    .desc = Древнее корабельное орудие, использующее биомеханические системы для накопления и высвобождения энергии. Несмотря на уникальный дизайн, оно устарело из-за уступающей механическим конструкциям скорости зарядки и стрельбы.
