...
ent-ClosetWallEmergencyN2 = настенный шкаф с аварийным азотом
...
ent-LockerWallEvacRepair = настенный шкаф для ремонта
    .desc = { ent-BaseWallLocker.desc }
ent-LockerWallBasePrisoner = настенный шкаф заключённого
    .desc = Это надёжный шкаф для личных вещей заключённого на время его пребывания в тюрьме.
    .suffix = 1
