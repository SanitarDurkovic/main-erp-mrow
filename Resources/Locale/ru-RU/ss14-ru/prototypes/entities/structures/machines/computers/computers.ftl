...
ent-ComputerResearchAndDevelopment = исследовательская консоль
    .desc = консоль, используемый для взаимодействия с оборудованием для РнД.
ent-ComputerAnalysisConsole = аналитическая консоль
    .desc = консоль, используемый для взаимодействия с анализатором артефактов.
...
ent-WizardComputerComms = консоль связи магов
    .desc = { ent-SyndicateComputerComms }
ent-CentcommComputerComms = консоль связи центкома
    .desc = { ent-ComputerComms }
...
ent-ComputerCargoOrdersEngineering = консоль инженерных запросов
    .desc = Используется инженерным отделом для заказа припасов.
ent-ComputerCargoOrdersMedical = консоль медицинских запросов
    .desc = Используется медицинским отделом для заказа припасов.
ent-ComputerCargoOrdersScience = консоль научных запросов
...
ent-ComputerCargoOrdersService = консоль служебный запросов
...
ent-ComputerFundingAllocation = консоль распределения финансирования
    .desc = Терминал для контроля распределения средств и выплат отделам.
...
ent-ComputerSalvageJobBoard = консоль объявлений утилизационных работ
    .desc = Консоль для доступа к заданиям по спасению, если вы достаточно сильны.
