...
ent-ClothingHandsGlovesNorthStar = перчатки полярной звезды
    .desc = Эти перчатки позволяют вам наносить удары невероятно быстро.
...
ent-ClothingHandsKnuckleDusters = кастет
    .desc = Холодные пласталевые кастеты, делающие ваши удары намного сильнее.
ent-ClothingHandsKnuckleDustersBrass = латунный кастет
    .desc = Латунный кастет, такой же, как делали раньше, и всё так же сильно бьёт.
ent-ClothingHandsKnuckleDustersQM = золотой кастет квартирмейстера
    .desc = 24-каратное золото, сплавленное с пласталью, с логотипом Nanotrasen. Настоящий символ мощи квартирмейстера.
ent-ClothingHandsKnuckleDustersSyndicate = кастет Синдиката
    .desc = Пластитановый кастет с кроваво-красной буквой S. Настоящий мужчина забивает кого-то до смерти этими.
ent-ClothingHandsKnuckleDustersStun = оглушающий кастет
    .desc = Кастет в сочетании с технологиями оглушающей дубинки. Это значительно упрощает избиение дебоширов.
ent-ClothingHandsKnuckleBoneCrushers = костедробители
    .desc = Благословлены Богами, чтобы сломить всех непокорных.
