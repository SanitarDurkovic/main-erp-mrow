...
ent-ClothingEyesHudFriedOnion = очки из жареного лука
    .desc = { "" }
ent-ClothingEyesHudOnionBeer = пивозрячие очки
    .desc = { "" }
ent-ClothingEyesHudMedOnion = медиканцинтозные очки
    .desc = { "" }
ent-ClothingEyesHudMedOnionBeer = пивно-моедицинские очки
    .desc = { "" }
...
ent-ClothingEyesHudMultiversal = мультиверсионыйе очки
    .desc = { "" }
ent-ClothingEyesHudOmni = очки "ОмниМен"
    .desc = { "" }
...
ent-ClothingEyesEyepatchHudDiag = диагностический моновизор
    .desc = Окуляр с индикатором на стекле, способный анализировать целостность и состояние роботов и экзокостюмов. Сделан из си-боргия.
ent-ClothingEyesEyepatchHudDiagFlipped = диагностическая повязка на глазу
