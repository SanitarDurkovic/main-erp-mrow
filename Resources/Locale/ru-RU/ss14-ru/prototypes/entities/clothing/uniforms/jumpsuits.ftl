...
ent-ClothingUniformJumpsuitEngineeringHazard = защитный комбинезон
    .desc = Соткан в теплом оранжевом цвете. Даёт окружающим понять, что вы действительно серьёзно относитесь к делу, когда речь идёт о работе.
...
ent-ClothingUniformJumpsuitScientist = комбинезон учёного
    .desc = Он сделан из специального волокна, которое обеспечивает слабую защиту от взрывов. На нем есть обозначения, указывающие что носитель является учёным.
