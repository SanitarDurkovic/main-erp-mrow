...
ent-ClothingUniformJumpskirtCommandGeneric = комбинезон-юбка командования
    .desc = Универсальная комбинезон-юбка командного цвета, не связанный с каким-либо конкретным отделом.
