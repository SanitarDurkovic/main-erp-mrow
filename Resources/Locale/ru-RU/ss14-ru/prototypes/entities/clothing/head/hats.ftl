...
ent-ClothingHeadHatBeretCommand = командный берет
    .desc = Берет с эмблемой командования. От него исходит аура авторитета.
...
ent-ClothingHeadHatCanadaBeanie = шапка-бини
    .desc = Красная, белая и уютная. Она излучает домашнее тепло, если ваш дом случайно прохладен и наполнен кофейнями.
...
ent-ClothingHeadWehcellentCap = превосходная кепка
    .desc = Это была сетчатая кепка! Тайдеры носят их постоянно! У нее сзади есть отверстия для вентиляции и всё такое!
...
ent-ClothingHeadHatSolidHeadband = прочная повязка на голову
    .desc = Вы почувствуете себя Невидимым, нося её! (ВНИМАНИЕ: НА САМОМ ДЕЛЕ НЕ ДЕЛАЕТ НОСИТЕЛЯ НЕВИДИМЫМ)
...
ent-ClothingHeadHatBeretHop = берет главы персонала
    .desc = Темно-синий берет с рубином по центру, для истинных ценителей бюрократии!
