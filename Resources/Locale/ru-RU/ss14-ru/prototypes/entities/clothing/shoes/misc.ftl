...
ent-ClothingShoeSlippersLizard = тапочки-плюшевые ящерицы
    .desc = Очаровательная пара тапочек, напоминающих ящеролюдей. Сочетайте их с другой зелёной одеждой, и вы станете самым крутым
...
ent-ClothingShoesBootsJump = прыжковые ботинки
    .desc = Высокотехнологичные ботинки, которые дают вам невероятную способность ПРЫГАТЬ! В этих ботинках вы можете перепрыгивать через лаву, пропасти и странные химикаты на полу!
