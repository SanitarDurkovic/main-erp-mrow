...
ent-FoodBoxDonkpocketMoth = коробка мотыль-кармашков
    .desc = { ent-FoodBoxDonkpocket.desc }
...
ent-FoodMealHappyHonkBigBite = Большая коробка еды «Весёлый Хонк»
    .desc = Кто-то заплатил хорошие деньги, чтобы эту еду из фастфуда доставили сюда. Она почему-то пахнет свежестью.
ent-FoodBoxCloth = коробка ткани марки "FlutterSoft"
    .desc = Волокно - важнейшая часть мольего рациона! Не пропускайте его и не используйте завалявшийся в шкафчике хлам, покупайте высококачественную ткань марки "FlutterSoft".
