...
ent-FoodBakedGrilledCheeseSandwich = прожаренный сырный сэндвич
    .desc = Хлеб и сыр зажаренные в масле, прекрасно для выходного дня в космосе!
ent-FoodBakedGrilledCheeseSandwichCotton = хлопковый сэндвич с сыром на гриле
    .desc = Хлопковый хлеб, слегка поджаренный на масле, с расплавленным сыром. Мотылькам трудно устоять перед этим сочетанием.
