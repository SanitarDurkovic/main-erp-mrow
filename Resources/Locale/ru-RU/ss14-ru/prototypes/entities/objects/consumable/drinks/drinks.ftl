...
ent-DrinkGlass = стакан-метаморф
    .desc = Стакан-метаморф, который автоматически превращается в ёмкость, соответствующую находящемуся в нем напитку. На донышке виден затёртый номер патента.
...
ent-DrinkAlienBrainHemorrhage = { ent-DrinkGlass }
    .suffix = мозговое кровоизлияние пришельца
    .desc = { ent-DrinkGlass.desc }
