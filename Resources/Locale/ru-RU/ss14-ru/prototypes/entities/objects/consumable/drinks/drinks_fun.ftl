...
ent-BottomlessLube = бездонный стакан с лубрикантом
    .desc = Этот аномальный стакан бесконечно производит космический лубрикант и поэтому его следует тщательно охранять, чтобы он не попал в чужие руки.
    .suffix = ДЕБАГ
ent-DrinkMopwataBottleRandom = вкуснейшая швабода
    .desc = Мутная коричневая бутылка с выцветшей этикеткой, изображающей швабру. Она наполнена мутным... винтажем.
