...
ent-FoodSnackMREBrownieOpen = брауни
    ...
    .suffix = ИРП
ent-FoodSnackSwirlLollipop = вихревой леденец на палочке
    .desc = Кружочек из чистого концентрированного сахара. Кто сейчас самый большой ребенок на игровой площадке?
