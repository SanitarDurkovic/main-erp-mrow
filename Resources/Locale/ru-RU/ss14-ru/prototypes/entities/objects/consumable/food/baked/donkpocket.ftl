...
ent-FoodDonkpocketMoth = мотыль-кармашек
    .desc = Жужжащая версия донк-кармашка, которая была создана во время массовых протестов о... Да кому это интересно? Просто донк-кармашки для мотыльков.
ent-FoodDonkpocketMothWarm = тёплый мотыль-кармашек
