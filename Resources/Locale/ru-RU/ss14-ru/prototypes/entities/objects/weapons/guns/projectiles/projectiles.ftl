...
ent-BulletTaserSuper = тазерный болт
    .desc = Если вы это видите, вас, скорее всего, оглушили
...
ent-WatcherBolt = заряд наблюдателя
    .desc = { ent-BaseBullet.desc }
ent-BoltTempgunCold = морозный болт
...
ent-BulletGrenadeFrag = осколочная граната
    .desc = { ent-BaseBulletTrigger.desc }
ent-BulletGrenadeCleanade = граната-чистальщик
    .desc = { ent-BaseBulletTrigger.desc }
