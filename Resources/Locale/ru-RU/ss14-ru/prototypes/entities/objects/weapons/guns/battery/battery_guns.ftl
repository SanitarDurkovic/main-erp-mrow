...
ent-WeaponTaserSuper = элитный тазер
    .desc = Энергетический оглушающий пистолет малой ёмкости, используемый элитными командами безопасности для обезвреживания даже самых стойких целей.
    .suffix = АДМИНЫ
...
ent-WeaponTemperatureGun = температурный пистолет
    .desc = Продвинутый пистолет, стреляющий лучами, изменяющими температуру тела. Это, вероятно, является каким-то военным преступлением.
ent-XenoborgLaserGun = лазер ксеноборга
    .desc = { ent-WeaponAdvancedLaser.desc }
ent-XenoborgHeavyLaserGun = тяжёлый лазер ксеноборга
    .desc = { ent-WeaponAdvancedLaser.desc }
