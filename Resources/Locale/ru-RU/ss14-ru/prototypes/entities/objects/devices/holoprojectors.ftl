...
ent-HolofanProjectorBorg = встроенный головентилятор
    .desc = Останавливает идиотов от причинения большего вреда экипажу во время атмосферных чрезвычайных ситуаций. Установлен непосредственно в инженерного киборга, перезаряжается со временем.
