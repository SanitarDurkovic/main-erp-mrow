...
ent-DoorRemoteCustom = пользовательский пульт от шлюзов
    .desc = Гаджет, который может удаленно открывать и блокировать двери. Этот продвинутый вариант не имеет встроенного доступа, вместо этого он наследует доступ по ID пользователя.
