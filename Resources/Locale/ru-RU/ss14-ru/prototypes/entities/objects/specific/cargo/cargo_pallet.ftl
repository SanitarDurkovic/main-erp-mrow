ent-BaseCargoPallet = грузовой поддон
    .desc = Распространённый элемент логистики и грузоперевозок. Ненавязчивое напоминание о том, куда ставить ящики во время транспортировки, чтобы избежать ушибов голеней.
