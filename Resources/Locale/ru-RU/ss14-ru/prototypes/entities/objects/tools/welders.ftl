ent-Welder = сварочный аппарат
    .desc = Плавит все что угодно, пока заправлен, не забывайте о защите глаз!
...
ent-RefuelingWelder = самозаправляющийся сварочный аппарат
    .desc = Медленный сварочный аппарат, который может заправляться со временем.
