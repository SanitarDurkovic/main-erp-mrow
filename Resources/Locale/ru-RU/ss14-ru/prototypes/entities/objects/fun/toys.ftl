...
ent-PlushieExperiment = экспериментальная плюшевая игрушка
    .desc = Плюшевая игрушка некоего псового, которая жаждет быть взорванной на мине.
...
ent-FoamBlade = пеноклинок
    .desc = Полустёртая надпись на нем выглядит непонятной игрой слов с использованием местных идиоматических выражений.
...
ent-PonderingOrbWizard = размышляющая сфера
    .desc = Задумчиво, чувак... Действительно задумчиво. Магическим образом показывает сеть камер станции.
    .suffix = Маг
