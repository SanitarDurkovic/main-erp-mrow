...
ent-ChameleonControllerImplant = имплант "контроллер хамелеона"
    .desc = Этот имплантат позволяет вам мгновенно изменить внешний вид всей одежды-хамелеона, которую вы носите.
...
ent-FakeMindShieldImplant = имплант ложной защиты разума
    .desc = Этот имплант позволяет имплантатору генерировать фальшивый сигнал, по которому охранные системы NT идентифицируют людей с защитой разума.
...
ent-RadioImplantCentcomm = имплант радио центкома
    .desc = Этот имплант предоставляет доступ к каналу ЦентКома без гарнитуры. Разрешён только сотрудникам ЦентКома.
ent-DeathRattleImplantCentcomm = имплант предсмертного хрипа Центрком
    .desc = Этот имплант уведомит радиоканал Центрком, если пользователь окажется в критическом состоянии или умрёт.
