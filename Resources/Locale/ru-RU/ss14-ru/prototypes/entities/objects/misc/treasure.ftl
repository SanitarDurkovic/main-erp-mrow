ent-TreasureDatadiskEncrypted = зашифрованный диск данных
    .desc = Старый диск с данными. Кто-то умнее вас смог бы его расшифровать и узнать что-нибудь интересное. Все, что вы можете сделать, это продать его.
...
ent-TreasureCoinIron = монета
    .desc = Плоский кусочек металла. Если бы он все ещё находился в обращении, инфляция сделала бы его бесполезным. Но поскольку это не так, она достаточно ценна, чтобы хранить её в книге.
