...
ent-PaperNanoTaskItem = Предмет НаноЗадачи
    .desc = Распечатанный предмет НаноЗадачи. Можно вставить в КПК, чтобы добавить его в ваши задачи.
...
ent-PaperSalvageJobLabel = этикетка заказа утилизационных работ
    .desc = Бумажная этикетка, обозначающая ящик как содержащий груз для выполнения работы по утилизации. Продажа ящика с этой этикеткой позволит выполнить задание.
