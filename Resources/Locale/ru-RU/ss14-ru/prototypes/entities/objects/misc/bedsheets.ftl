...
ent-BedsheetCMO = одеяло главврача
    .desc = Это стерилизованное одеяло, украшенное эмблемой креста. На нем осталась кошачья шерсть, вероятно, от Рантайма.
...
ent-BedsheetRD = одеяло научрука
    .desc = На нем имеется эмблема с мензуркой, и сделано оно из огнестойкого материала, который, вероятно, не защитит вас в случае пожаров, с которыми вы сталкиваетесь ежедневно.
