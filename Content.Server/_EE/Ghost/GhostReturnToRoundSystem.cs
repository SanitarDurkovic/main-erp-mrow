...
namespace Content.Server._EE.Ghost;
...
public sealed class GhostReturnToRoundSystem : EntitySystem
{
    ...
    {
        var maxPlayers = _cfg.GetCVar(EECCVars.GhostRespawnMaxPlayers);
        ...
        var timeUntilRespawn = TimeSpan.FromMinutes(_cfg.GetCVar(EECCVars.GhostRespawnTime));
