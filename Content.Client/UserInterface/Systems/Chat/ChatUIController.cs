...
public sealed partial class ChatUIController : UIController
{
    ...
    public static readonly Dictionary<char, ChatSelectChannel> PrefixToChannel = new()
    {
        ...
        {SharedChatSystem.HiddenEmotesPrefix, ChatSelectChannel.HiddenEmotes}, // LOP edit
    ...
    public static readonly Dictionary<ChatSelectChannel, char> ChannelPrefixes = new()
    {
        ...
        {ChatSelectChannel.HiddenEmotes, SharedChatSystem.HiddenEmotesPrefix}, // LOP edit
    ...
    private void UpdateChannelPermissions()
    {
        ...
        if (_state.CurrentState is GameplayStateBase)
        {
            ...
            FilterableChannels |= ChatChannel.HiddenEmotes; // LOP edit
            ...
            if (_ghost is not {IsGhost: true})
            {
                ...
                CanSendChannels |= ChatSelectChannel.HiddenEmotes; // LOP edit
            }
        }
